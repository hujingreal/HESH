...
cmd_ycsb_load = ycsb_dir + 'bin/ycsb.sh load basic -P ' +  workload_dir + workload + ' -threads 72 -s > ' + ycsb_load
cmd_ycsb_run = ycsb_dir + 'bin/ycsb.sh run basic -P ' +  workload_dir + workload + ' -threads 72 -s > ' + ycsb_run
