...
constexpr Value_t DEFAULT = UINT64_MAX;
#define CAS(_p, _u, _v)                                             \
  (__atomic_compare_exchange_n(_p, _u, _v, false, __ATOMIC_ACQUIRE, \
                               __ATOMIC_ACQUIRE))
const size_t INVALID = -1UL;  // 11111...111
const size_t NONE = 0;
const size_t SENTINEL = -2UL;  // 11111...110
using namespace very_pm;
typedef void (*DestroyCallback)(void* callback_context, void* object);
static size_t hash_func(size_t k, size_t _len = 8,
